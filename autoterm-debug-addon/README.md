...
experimental handshake frame toward the heater on the live bus (the known
issue where the heater's reply confused the physical panel is fixed as of
1.1.0, but treat it as still experimental beyond that).
